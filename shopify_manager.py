...
CONFIG_FILE = "/home/fuckadmin/Projects/shop.zyekh.com/.shopify_env"
...
<script 
  ...
  defer>
    ...
    if "ai-chat-widget" not in theme_liquid and "{% render 'ai-chat-widget' %}" not in theme_liquid:
        ...
        print("Snippet sudah terdaftar di theme.liquid sebelumnya.")

    print("\nWIDGET AI CUSTOMER SERVICE RESMI AKTIF DI TOKO SHOPIFY ANDA!")

if __name__ == "__main__":
    if len(sys.argv) < 2 or "--help" in sys.argv:
        print("Shopify Integration Tool for Zyekh Ecosystem")
        print("-------------------------------------------------")
        print("Perintah:")
