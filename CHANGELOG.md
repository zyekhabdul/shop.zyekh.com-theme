...
**AI Hero Banner Image Asset & Category SVG Scale Adjustment:**
- Generasi Gambar AI Hero Banner: Membuat gambar produk e-commerce resolusi tinggi (`assets/hero-banner-1.jpg`) menggunakan prompt fotografi produk 8k (laptop, smartwatch, headphones, diffuser, smartphone) dan diintegrasikan sebagai gambar latar belakang utama Hero Carousel ([sections/hero-carousel.liquid](file:///home/fuckadmin/Projects/shop.zyekh.com-theme/sections/hero-carousel.liquid#L15)).
- Proporsi Ikon Kategori: Mengurangi ukuran SVG ikon kategori dari `34px` menjadi `28px` di [sections/category-carousel.liquid](file:///home/fuckadmin/Projects/shop.zyekh.com-theme/sections/category-carousel.liquid#L39) agar berada presisi di tengah-tengah lingkaran avatar tanpa ada garis stroke yang terpotong/overflow.
